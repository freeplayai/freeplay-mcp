...
from freeplay_mcp.vendor.swagger_client.models.create_template_version_request1 import (  # type: ignore[import-untyped]
    CreateTemplateVersionRequest1,
)
from freeplay_mcp.vendor.swagger_client.rest import (
